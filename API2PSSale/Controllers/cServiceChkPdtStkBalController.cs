...
namespace API2PSSale.Controllers
{
    ...
    public class cServiceChkPdtStkBalController : ControllerBase
    {
        ...
        public cmlRespone POST_CHKPdtStkBal(cmlPdtStk poPdtStk)
        {
            ...
            try
            {
                ...
                {
                    oRes = new cmlRespone();
                    oRes.rtCode = cMS.tMS_RespCode700;
                    oRes.rtDesc = cMS.tMS_RespDesc700;
                }
                ...
                foreach (var oItem in aoWah)
                {
                    ...
                    {
                        oRes = new cmlRespone();
                        oRes.rtCode = cMS.tMS_RespCode001;
                        oRes.rtDesc = cMS.tMS_RespDesc001;
                        return oRes;
                    }
