...
namespace API2PSSale.Models.Database
{
    public class cmlTPSTSalRC
    {
        ...
        public string FTXrcRteChg { get; set; }                   //*Nick 65-08-23
        public Nullable<decimal> FCXrcRteChgFac { get; set; }     //*Nick 65-08-23      

        public Nullable<decimal> FCXrcChgRnd { get; set; }  //*Arm 65-09-04 -[CR-OverSea]
        public Nullable<decimal> FCXrcRteChgAmt { get; set; }  //*Arm 65-09-06 -[CR-OverSea]
    }
}